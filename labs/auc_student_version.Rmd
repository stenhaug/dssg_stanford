...
14. Plot and calculate the AUC. How does this look? How good do you feel about this model?
```{r}
...
15. How does this compare to the "model" we have before? Calculate maximum accuracy of the "model" above - how does this compare to the accuracy max-class model below? What do you think of the original model now?
```{r}
...
16. Plot the precision-recall curve for the imbalanced data. Is this helpful? Why? Describe what happens in this plot. 
```{r}
...
17. What is the precision and recall of the max-class model?
